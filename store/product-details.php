...
<body>
				...
				<div class="row">
					<div class="col-sm-6">
						<div class="contactinfo">
							...
							<li><a href=""><i class="fa fa-phone"></i> +880184299997</a></li>
								<li><a href=""><i class="fa fa-envelope"></i> </strong>luminousfuturebd.com</strong></a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-6">
	...
	<footer id="footer"><!--Footer-->
		<div class="footer-bottom">
			<div class="container">
				<div class="row">
					<p class="pull-left">Copyright © amarfashionbd Inc. All rights reserved.</p>
